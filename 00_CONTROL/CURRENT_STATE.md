# Repository Control Current State

**Baseline:** Gradient Portfolio and Authority Matrix — Repository Baseline v0.1  
**Created:** 2026-07-29  
**Scope:** Repository-controlled intake baseline. It does not establish live authority, current project state, or production permission.
...
Before a candidate receives a current status, resolve authority in the ordered model in `AUTHORITY_REGISTER.yaml`. The imported Matrix cannot establish authority by itself.
