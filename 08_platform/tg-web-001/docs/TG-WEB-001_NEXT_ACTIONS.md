...
|---|---|---|---|
| 1 | **Remediate Vol I Git size (~135 MB > GitHub 100 MB limit)** — Git LFS for `assets/pdf/*.pdf`, OR remove print PDFs from Git and deploy via Netlify-only asset bundle | Steward + implementer | **Yes — push blocked without this** |
